...
**Usage Rules:**
- **Always include the Copart header** at the top of every prototype page unless explicitly told not to. Use the existing component files (`demo/copart-header.html` for logged-out, `demo/copart-header-loggedin.html` for logged-in) — do not recreate or improvise a header.
