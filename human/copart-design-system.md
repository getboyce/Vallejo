...
> Error and destructive states use a deep, true red (#C20022).
...
| Token | Hex | Usage |
|-------|-----|-------|
| `error-bg-subtle` | `#FDF1F2` | Filter chips, badge fills, quiet error surfaces |
| `error-bg` | `#FBDADC` | Toasts, alerts, banners, destructive action surfaces |
| `error-text` | `#8A0015` | Error message text (7.12:1 on error-bg — **AAA**) |
...
| Token | Light Mode | Dark Mode | Notes |
|-------|-----------|-----------|-------|
| `neutral-0` | `#FFFFFF` | `#1A1D23` | Page background — pure base canvas (dark matches `neutral-50`) |
| `neutral-50` | `#F8F7F8` | `#1A1D23` | Subtle surface — off-white fills, alt rows |
...
| Error | `#FBDADC` → `#371015` | `#8A0015` → `#F5616B` | `#F5616B` | `#F5616B` |
...
| Hover | `#8A0015` | White | None |
| Active | `#5C000E` | White | None |
| Disabled | Neutral 200 | Neutral 700 | None |
...
| Error | `#8A0015` | White | Exclamation |
...
**Error states.** Use the error token palette (`#C20022`, `#8A0015`) for all error, destructive, and negative states. If a third-party library injects an off-palette red (e.g., form validation, chart libraries), override it with the error tokens.
